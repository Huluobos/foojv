...
var api = {
    ...
    forgetPwd:"api.php?s=Login/forget",/*重置密码*/
    updateName:"api.php?s=Login/update",/*重置用户名*/
    mobileVerify:"api.php?s=Msg/send_msg",/*手机验证*/
    mobileVerifyOk:"api.php?s=Msg/verify",/* 验证码核验*/
    used_lists:"api.php?s=Product/used_lists",/*二手房列表*/
    newHouse:"api.php?s=Product/recommend_pc",/* 新房首页列表*/
    newHouseSearch:"api.php?s=Basics/drop_down_pc",/* 新房搜索框*/
    houseCollect:"api.php?s=Operation/houseCollect",/*房源收藏*/
    houseCollectCancel:"api.php?s=Operation/houseCollectCancel",/*取消房源收藏*/
    myHouseCollect:"api.php?s=Operation/userCollect",/*我的关注房源*/
    myHouseCollect4:"api.php?s=Operation/villageCollectList",/*我的关注房源4*/
